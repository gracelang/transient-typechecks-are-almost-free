...
data <- rbind(
  select(load_data_file("benchmark-5adea5e8a0f6b60a4eaabc2e2b838ce666ab5799.data.bz2"),
         c("Value", "Unit", "Benchmark", "VM", "Iteration")),
  select(load_data_file("benchmark-d98bf528ae475c426b33ac4cfa07852a48054d10.data.bz2"),
         c("Value", "Unit", "Benchmark", "VM", "Iteration"))
)
