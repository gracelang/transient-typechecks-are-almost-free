...
In this paper, we demonstrate that an
optimizing virtual machine makes transient type checks ``almost
free.''
These checks
...
We evaluate our approach by adding transient checks to Moth,
