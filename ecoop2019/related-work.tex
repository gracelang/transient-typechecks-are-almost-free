...
be incompatible with those annotations, that type annotations cannot change
...
%
Moth does not meet the refined formal statement of theguarantee in
\citet{XXXSiek2015}'s Theorem 5, however, because Theorem 5 requires
