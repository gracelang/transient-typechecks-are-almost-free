...
Because Grace only checks explicit type declarations (not inferred
intermediate types), Grace cannot not meet the gradual guarantee,
as in erasure-based gradual semantics. Grace ensures only that
...
places to Grace.  Grace explicitly checks type anotations, while
