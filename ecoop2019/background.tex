...
since they group together objects with common structures.
...
Graal aggressively inlines the resulting code.
This is important as it enables the same
optimization opportunities enjoyed by
classic just-in-time compilers, such as  
constant folding,
...
because Moth relies on techniques
such as self-optimizing nodes, PICs, and object shapes.
These techniques all introduce various checks;
