...
In particular,
loop-invariant code motion and common subexpression elimination are two optimizations that
are important for generating efficient native code for dynamic languages:
they help to remove redundant checks introduced by self-optimizing nodes, PICs, and object shapes.
