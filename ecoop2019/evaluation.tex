...
reports absent type information to ensure each benchmark was complete).
...
The baseline without optimizations are the rows with the results
...
\begin{figure}
	...
	\caption{PERF  IMPACT OF OPTIMIZATIONS. TODO!}
