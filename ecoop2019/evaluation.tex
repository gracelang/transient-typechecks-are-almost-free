...
Thus, \code{check\_generic} is the test called when ever a full type check has to
be performed, and \code{is\_subtype\_of} is part of it to determine the relationship
between two types.
As such, we expect \code{check\_generic} to used most often.
