...
both \code{personal\-Car} and \code{governmentCar} conform to the type
\code{Vehicle} because that type considers only the ability to respond
to the \code{registration} \code{registerTo} messages
