...
An important aspect of our design is that it allows students to see 
concrete examples of type errors. 
In \cref{ex:complex}, the student
...
(\cref{ex:government-car:registerTo}) will the gradual type test on the
argument fail (the object that is passed in is not a
