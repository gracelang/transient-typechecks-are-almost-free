...
%
In the spectrum of gradual typing, Grace's semantics are essentially the
...
also check method return values
and variable assignments and reads (see \$\ref{reticRW}).
