...
%
%   \rephrase{Languages with optional explicit dynamic type checking, like
%   Typescript, Dart, Groovy,}\sm{this is not correct. See
%   email. needs to be rephrased!} and Grace are increasingly popular
%   in 
  Languages with explicit dynamic type checking
%, like
%  Typescript, Dart, Groovy,}\sm{this is not correct. See email. needs
%  to be rephrased!} and Grace 
  are increasing in popularity in both
  ...
  how virtual machines can use common optimizations to remove
  redundancy in dynamic type checking, by adding shallow structural type
