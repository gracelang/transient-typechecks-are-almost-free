...
are becoming increasingly popular in practical development and education.
Unfortunately,
current implementations of gradual languages tend to
perform worse than either purely static or purely dynamically typed languages.
Removing type tests make programs in these languages run faster. 
