...
In contrast, gradual type systems retain types until runtime,
...
for an optional type system.\mwh{Wait, what?}
...
called ``Boyand checks''\citep{Boyland2014}\mwh{No.}).
...
which allows Moth to reduce redundancy between checking structure
...
\item shallow dynamic type checking with minimal overhead
      ...
      with performance comparable to V8 JavaScript\mwh{This doesn't really sound like a contribution. Is the contribution an approach, a demonstration of practicality, or what? It doesn't match with what was said above either.}
