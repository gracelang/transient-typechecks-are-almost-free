...
with a slowdown of \ugh{only a few percent}\smtodo{make more precise}.
...
\ugh{demonstrating speedups}\smtodo{make more precise} as more type information is added to programs. \sm{may want to discuss here how we relate to their implementation technique}
...
\sm{Indication that results of \citet{Richards2017}
