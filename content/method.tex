...
To get this support the support adds a type annotation to the method 
...
without negatively affectingly the performance portfolio.
...
All cells in the matrix begin are unknown and as 
encounter a check during execution
...
the same type to type relationships across different checks in the program. To reduce redundancy further we also unify type.
