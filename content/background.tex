...
by several other optionally typed languages including \del{Groovy,
TypeScript} and Dart\citep{Muehlboeck2017}.\sm{I am not sure that, as it is phrased, is actually true.
