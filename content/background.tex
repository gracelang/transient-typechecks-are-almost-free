...
dynamic type checking\mwh{I'm not convinced this is what Unknown does.}).
...
adding type declarations to a program makes that program run slower\mwh{This is simply not true. Most extant implementations have no performance impact whatsoever from adding type declarations, because they disregard them entirely.}---teaching students that \emph{removing} type declarations is an
